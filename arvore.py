...
def editar(arvore, categoria, novo, id):
    nozinho = (buscar(arvore, id))
    setattr(nozinho, categoria, novo)
...
if __name__ == "__main__":
    ...
    if (choice == '1'):
        ...
        choice = input("imprimir=1  editar=2  exluir=3  sair=0 ")
        while (int(choice) != 0):
            if choice == '1':
                printarvore(arvore)
            if choice == '2':
    ...
    if (choice == '2'):
        choice = input("imprimir=1  editar=2 excluir=3 sair=0 ")
        while (int(choice) != 0):
            if choice == '1':
                printarvore(arvore2)
            if choice == '2':
