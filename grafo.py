...
for i in range(10):
    ...
    criararesta(i, x, grafo, int(grafo.verticies[i].airline_sentiment_confidence))
    criararesta(i, y, grafo, int(grafo.verticies[i].airline_sentiment_confidence))
    criararesta(i, z, grafo, int(grafo.verticies[i].airline_sentiment_confidence))
